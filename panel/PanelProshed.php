...
$result = $mysqli->query("SELECT Events.Id_Events, Events.type_id, Events.Quantity_For_events, Status_Event.Status, Events.Date_EV, Events.Time_EV, Type.Type  FROM Events INNER JOIN Type ON Type.id = Events.type_id INNER JOIN Status_Event ON Events.id_status = Status_Event.id WHERE id_status = 1");
        ...
        <div class="row">
            ...
            <ul class="nav flex-column">
                        <li class="nav-item">
                            ...
                            <a class="nav-link active disabled" href="PanelProshed.php">-Прошедшие</a>
                        </li>
                        <li class="nav-item">
