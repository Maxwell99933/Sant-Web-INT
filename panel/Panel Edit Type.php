...
$result = $mysqli->query("SELECT Type, Description, imgname FROM Type WHERE id='$type_id' ");
...
?>
    ...
    <head>
        ...
        <title>Вид События / Редактировать</title>
        <style>
        .active{
            font-weight: 700;
        }
        ...
        <div class="container-fluid">
                ...
                <div class="col-12 bg-light text-dark">
                    ...
                    <div class="row">
                        <a class="mx-auto text-dark">
                            <h4>Вид События / Редактировать</h4>
                        </a>
                    </div>
                </div>
            ...
            <ul class="nav flex-column">
                ...
                <div class="col-10 mx-auto">
                    ...
                    <form action="UpdateType.php" method="post" enctype="multipart/form-data">
                        <div class="row" style="min-height: 50px;">
                            <div class="col-3">
                                <input style="display: none;" type="text" name="type_id" value="<?php echo $type_id; ?>">
