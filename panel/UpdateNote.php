...
mysqli_set_charset($mysqli, "utf8");
    ...
    $result = $mysqli->query("UPDATE NOTE_FOR_Events SET client_id_FK = {$client_id_FK}, FName = '$FName', LName = '$LName', Who = '$Who', WhoNUM = '$WhoNUM', Comment = '$Comment', visit_id = '$Status' WHERE Id_Note_EVENTS = '$Id_Note_EVENTS' ");
