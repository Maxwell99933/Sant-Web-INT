...
$result = $mysqli->query("SELECT Events.Id_Events, Events.type_id, Events.Quantity_For_events, Status_Event.Status, Events.Date_EV, Events.Time_EV, Type.Type  FROM Events INNER JOIN Type ON Type.id = Events.type_id INNER JOIN Status_Event ON Events.id_status = Status_Event.id WHERE id_status = 2");
...
<head>
    ...
    <title>События назначенные</title>
    <style>
        .active{
            font-weight: 700;
        }
        ...
        <div class="row">
            ...
            <ul class="nav flex-column">
                        <li class="nav-item">
                            ...
                            <a class="nav-link active disabled" href="PanelNazn.php">-Назанченные</a>
